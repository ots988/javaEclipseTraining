...
//    /**
//     * 获取系统流水号
//     * @see 若欲指定返回值的长度or是否全由数字组成等,you can call {@link Common#getSysJournalNo(int, boolean)}
//     * @return 长度为20的全数字
//     */
...
//     * @see And the calls {@link Common#getHexSign(String,String,String,boolean)}进行签名
...
//     * @see It will Calls {@link Common#getBytes(String str, String charset)}
